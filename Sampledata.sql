...
GRANT ALL PRIVILEGES ON TABLE REVIEW_ANALYZER_DB.PUBLIC.SAMPLE_INSURANCE_REVIEWS TO APPLICATION ReviewAnalyzer;
GRANT ALL PRIVILEGES ON TABLE REVIEW_ANALYZER_DB.PUBLIC.SAMPLE_INSURANCE_CATEGORIES TO APPLICATION ReviewAnalyzer

--Note: You can also load tables directly into the REVIEW_ANALYZER_DB.PUBLIC and grant the above privileges


----SAMPLE REVIEW FOR FREE TEXT----
(The new menu items were a nice surprise. I tried the chicken sandwich, and it was flavorful and well-cooked. 
However, I felt the portion size was a bit small for the price I paid. 
The restaurant was moderately busy, and the service was fairly quick. While the food was good, I wouldn’t say it was exceptional. 
Overall, it was a decent experience, but there is room for improvement in terms of portion size and overall value.)